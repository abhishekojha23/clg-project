	...
	<section class="page-section" id="flight" >
        <div class="container">
        	<div class="card">
				...
				while($row = $airport->fetch_assoc()){
					$name[$row['id']] = ucwords($row['airport'].', '.$row['location']);
				}
				...
				<div class="row align-items-center">
					...
					<div class="col-md-6">
						 <p><b><?php echo $name[$row['departure_airport_id']].' - '.$name[$row['arrival_airport_id']] ?></b></p>
					...
					<div class="col-md-3 text-center align-self-end-sm">
						...
						<button class="btn-outline-primary  btn  mb-4 book_flight" type="button" data-id="<?php echo $row['id'] ?>"  data-name="<?php echo $name[$row['departure_airport_id']].' - '.$name[$row['arrival_airport_id']] ?>" data-max="<?php echo $row['seats'] - $booked ?>">Book Now</button>
					</div>
				</div>
